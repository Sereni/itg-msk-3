...
urlpatterns = patterns('',
    ...
    url(r'^final/$', 'special_random.main.views.final', name="final"),
    url(r'^final/(?P<pk>.*)/$', 'special_random.main.views.final', name="final"),
    url(r'^final/(?P<pk>.*)/(?P<take_pk>.*)$', 'special_random.main.views.final', name="final"),
